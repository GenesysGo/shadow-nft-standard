...
exports.updateMetadata = exports.layout = void 0;
const borsh = __importStar(require("@coral-xyz/borsh"));
const web3_js_1 = require("@solana/web3.js");
const programId_1 = require("../programId");
const types = __importStar(require("../types"));
exports.layout = borsh.struct([types.UpdateMetaArgs.layout("args")]);
function updateMetadata(args, accounts, programId = programId_1.PROGRAM_ID) {
    const keys = [
